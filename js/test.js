...
// console.log(nady);
// Enums: used to store closely related values mainly for small data, that are known during the compile time; becuase we cant add or update anything in it after compiling like data from a http request for example.
